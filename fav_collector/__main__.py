...
from .human import human_scroll, random_mouse_jitter
from .storage import compute_hash, download_image, load_seen_hashes, save_image_and_meta
from .tweets import clean_url_to_orig, extract_image_urls, extract_meta, find_articles, has_video
...
def main():
    setup_logging()
    log.info("Starting fav collector")
    ...
    try:
        ...
        while True:
            ...
            if stale_cycles >= config.MAX_STALE:
